...
var src_avatar_cropper;
var src_cover_cropper;
var editAvatarModal;
var editCoverModal;
...
(function (factory) {
  ...
  function CropAvatar($element, photo) {
    this.$container = $element;
    this.photo = photo;
    this.$avatarView = this.$container.find("."+photo+"-view");
    this.$avatar = this.$avatarView.find("img");
    this.$avatarModal = this.$container.find("#"+photo+"-modal");
    this.$loading = this.$container.find(".loading");

    this.$avatarForm = this.$avatarModal.find("."+photo+"-form");
    this.$avatarUpload = this.$avatarForm.find("."+photo+"-upload");
    this.$avatarSrc = this.$avatarForm.find("."+photo+"-src");
    this.$avatarData = this.$avatarForm.find("."+photo+"-data");
    this.$avatarInput = this.$avatarForm.find("."+photo+"-input");
    this.$avatarSave = this.$avatarForm.find("."+photo+"-save");

    this.$avatarWrapper = this.$avatarModal.find("."+photo+"-wrapper");
    this.$avatarPreview = this.$avatarModal.find("."+photo+"-preview");
  ...
  CropAvatar.prototype = {
    ...
    initPreview: function () {
      ...
      if(this.photo=="avatar"){
    	  this.$avatarPreview.empty().html('<img class="cropper" alt="Picture" id="ImgAvatarUpload" src="' + url + '">');
      }
      else
      {
    	  this.$avatarPreview.empty().html('<img class="cropper2" alt="Picture" id="ImgCoverUpload" src="' + url + '">');
      }
    },
    ...
    startCropper: function () {
      ...
      if (this.active) {
        this.$img.cropper("replace", this.url);
    	  ...
    	  if(this.photo=="avatar"){
        	  document.getElementById("image-avatar-wrapper").src=this.url;
        	  this.$img = $("#image-avatar-wrapper");    		  
    	  }
    	  else
    	  {
        	  document.getElementById("image-cover-wrapper").src=this.url;
        	  this.$img = $("#image-cover-wrapper");
    	  }	  
  ...
  $(function () {
    var example = new CropAvatar($("#crop-avatar"), "avatar");
    var example2 = new CropAvatar($("#crop-cover"), "cover");
    editAvatarModal = example.$avatarModal;
    editCoverModal = example2.$avatarModal;
  });
});
...
(function (factory) {
  ...
  Cropper.prototype = {
    ...
    load: function () {
      ...
      if(this.photo=="avatar")
    	  this.$clone = ($clone = $("<img" + ((typeof $this.attr("crossOrigin") !== STRING_UNDEFINED || this.isCrossOriginURL(url)) ? " crossOrigin" : "") + ' src="' + url + '" class="cropper" alt="Picture">'));
      else
    	  this.$clone = ($clone = $("<img" + ((typeof $this.attr("crossOrigin") !== STRING_UNDEFINED || this.isCrossOriginURL(url)) ? " crossOrigin" : "") + ' src="' + url + '" class="cropper2" alt="Picture">'));
    ...
    replace: function (url, /*INTERNAL*/ rotated) {
      ...
      if (url && url !== this.url && url !== $this.attr("src")) {
        ...
        if ($this.is("img")) {
          ...
          $('<img class='+cropper+' src="' + url + '">').one("load", function () {
...
(function() {
	...
	$("#btnUpdateAvatar").click(function() {
		...
		src_avatar_cropper = dataURL.split(',')[1];
	});

	$("#btnUpdateCover").click(function() {
		var dataURL2 = $image2.cropper("getDataURL");
		src_cover_cropper = dataURL2.split(',')[1];
	});	
}());